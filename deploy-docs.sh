...
scribble +m --redirect-main http://docs.racket-lang.org/ --html --dest ./docs --dest-name index ./aws-cloudformation-template-doc/scribblings/aws/cloudformation/template.scrbl
